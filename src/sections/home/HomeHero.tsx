      ...
      {slide.kind === "intro" ? (
        <div className="relative z-10 flex h-full flex-col items-center justify-center gap-1 px-5 pt-1 text-center sm:px-8">
          ...
          <motion.span
            ...
            className="mt-4 inline-flex max-w-[min(100%,28rem)] items-center justify-center rounded-full bg-gradient-to-r from-[rgba(100,220,210,0.96)] to-[rgba(220,215,140,0.96)] px-7 py-2.5 text-[clamp(12px,1.05vw,15px)] font-semibold leading-snug tracking-[0.02em] text-neutral-900 shadow-[0_6px_22px_rgba(0,0,0,0.25),0_0_0_1px_rgba(255,255,255,0.14)] sm:mt-5 sm:px-9 sm:py-3"
          >
